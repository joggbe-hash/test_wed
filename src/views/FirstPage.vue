      ...
      <div class="feed-content">
        <div class="post-card show" style="opacity: 1; transform: translateY(0);">
          ...
          <div class="post-body">
            ...
            <div style="font-size: 18px; color: #333; margin-bottom: 30px;">(打字框)</div>
        ...
        <div v-for="post in ['個人內容', '發佈內容']" :key="post" class="post-card show" style="opacity: 1; transform: translateY(0);">
          <div class="post-avatar" @click="router.push('/personal')"></div>
