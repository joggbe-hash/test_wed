      ...
      <div class="feed-content">
        ...
        <div class="post-card show" style="opacity: 1; transform: translateY(0);">
          ...
          <div class="post-body">
            ...
            <div style="font-size: 18px; color: #333; margin-bottom: 30px;">輸入內容</div>
            <div style="display: flex; justify-content: space-between; align-items: center;">
              ...
              <div style="display: flex; align-items: center; gap: 15px; color: #7A7A7A;">
                ...
                <button class="post-action-btn" style="position: static; padding: 10px 25px; background-color: #4A3320; min-width: 120px;" @click="isPrivate = !isPrivate">{{ isPrivate ? '私人發布' : '公開分享' }}</button>
              </div>
            </div>
          </div>
        </div>

        <div v-for="item in 8" :key="item" class="post-card show">
          <div class="post-avatar" @click="router.push('/personal')"></div>
          <div style="display: flex; flex-direction: column; flex: 1; min-width: 0;">
            <div class="post-body">
              <div v-if="item % 2" style="font-size: 16px; color: #333; line-height: 1.6;">社群貼文</div>
